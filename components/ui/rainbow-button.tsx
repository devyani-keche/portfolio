  ...
  ),
  {
    variants: {
      variant: {
        ...
        custom:
          "border-0 bg-white text-black font-semibold shadow-lg hover:shadow-xl transition-all duration-300 relative before:absolute before:bottom-[-25%] before:left-1/2 before:z-0 before:h-2/5 before:w-4/5 before:-translate-x-1/2 before:bg-gradient-to-r before:from-pink-400/60 before:via-rose-500/60 before:to-pink-600/60 before:[filter:blur(1rem)] before:animate-pulse hover:before:[filter:blur(1.5rem)]",
      },
      size: {
        default: "h-9 px-4 py-2",
        sm: "h-8 rounded-xl px-3 text-xs",
        lg: "h-14 rounded-xl px-3 md:px-6 text-base md:text-lg  border-2 border-pink-300",
        xl: "md:h-16 h-12 rounded-xl px-6 md:px-16 text-lg md:text-xl border-2 border-pink-300/50",
        icon: "size-9",
      },
    },
    defaultVariants: {
